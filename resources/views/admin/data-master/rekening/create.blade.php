@extends('layout.app_admin',['title_satu'=>'Form Tambah','title_dua'=>'Rekening'])
...
@endif
<form action="{{ route('admin.data-master.rekening.store') }}" method="POST" class="card">
    @csrf
    <div class="card-body">
        <div class="row">
            <div class="col-lg-4 mb-3">
                ...
                <div class="form-selectgroup">
                    ...
                    <label class="form-selectgroup-item">
                        <input type="radio" name="jenis" value="E-Dompet" class="form-selectgroup-input" @if(@old('jenis') == 'E-Dompet') checked @endif>
                        <span class="form-selectgroup-label">
            ...
            <div class="col-lg-4 mb-3">
                ...
                <div>
                    <input type="text" name="nama_bank_dompet" class="form-control @error('nama_bank_dompet') is-invalid @enderror" value="{{ @old('nama_bank_dompet') }}" placeholder="Nama Bank/E-Dompet..">
                </div>
            </div>
            <div class="col-lg-4 mb-3">
