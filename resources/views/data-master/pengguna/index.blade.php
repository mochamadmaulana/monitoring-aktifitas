@extends('layout.app',['title_satu'=>'View','title_dua'=>'Pengguna'])

@push('btn-page-header')
<div class="col-auto ms-auto d-print-none">
    <div class="btn-list">
        <a href="{{ route('data-master.pengguna.create') }}" class="btn btn-primary d-none d-sm-inline-block" >
                            ...
                            <div class="btn-list flex-nowrap float-end">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        <a class="dropdown-item" href="{{ route('data-master.pengguna.edit',$p->id) }}">
                                            Edit
                                        </a>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Yakin, untuk menghapus : <span id="nama-bank_lengkap"></span>
            </div>
...
function confirmDelete(id) {
    ...
    $.ajax({
        url: '{{ url('data-master/pengguna') }}/' + id,
        type: 'delete',
